...
import { IPurchaseBillWise } from '../../AllReportsInterfaces/IPurchaseBillWise';
...
@Component({
  selector: 'app-purchasebillwise',
  templateUrl: './purchasebillwise.component.html',
  styleUrls: ['./purchasebillwise.component.scss']
})
export class PurchasebillwiseComponent implements OnInit {

  
purchaseBillWise:any= new IPurchaseBillWise();
purchaseArr:any= new Array<IPurchaseBillWise>();
filterTerm='';
tDate:any;
fDate:any;
billType:any;
...
constructor(
  ...
  getReport(){
    ...
    this.service.getBWPurchaseReport(this.fDate, this.tDate).subscribe(res=>
      {
        if(res){
          this.isData=true;
        ...
        this.purchaseArr.forEach((b:any) => {
          debugger
            ...
            b.bills.forEach((c:any) => {
                content += `
                                <tr>
                                <td style="width: 60%; text-align: left;">${c.itemName}</td>
