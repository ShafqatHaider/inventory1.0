...
import { IPurchaseItemParty } from '../../AllReportsInterfaces/IPurchaseItemParty';
import { Location } from '@angular/common';

@Component({
  selector: 'app-purchaseitemparty',
  templateUrl: './purchaseitemparty.component.html',
  styleUrls: ['./purchaseitemparty.component.scss']
})
export class PurchaseitempartyComponent implements OnInit {
  purchaseItem= new Array <IPurchaseItemParty>();
  pArr= new Array<IPurchaseItemParty>();
  filterTerm:string="";
  qtyTotal:number=0;
  billTotal: number=0;
  purchaseArray=[];
...
this.progress = 0;
    ...
    this.service.getIPPurchaseReport(this.fDate, this.tDate).subscribe(res=>{
