...
import { ISaleBillWise } from '../../AllReportsInterfaces/ISaleBillWise';
import { DatePipe } from '@angular/common';
import { ReportsService } from '../../reports.service';
import { Router, ActivatedRoute } from '@angular/router';
import { Location } from '@angular/common';
@Component({
  selector: 'app-salebillwise',
  templateUrl: './salebillwise.component.html',
  styleUrls: ['./salebillwise.component.scss'],
})
export class SalebillwiseComponent implements OnInit {
  saleBillWise: any = new ISaleBillWise();
  saleBillArr: any = new Array<ISaleBillWise>();
  saleArr: any = [];
  filterTerm = '';
  tDate: any;
  fDate: any;
  ...
  getReport() {
    this.service.getBWSaleReport(this.fDate, this.tDate).subscribe((res) => {
    if(res)
    {
      this.isData=true;
