...
import { ISaleItemPartyST } from '../../AllReportsInterfaces/ISaleItemPartyST';
...
@Component({
  selector: 'app-saleitempartyst',
  templateUrl: './saleitempartyst.component.html',
  styleUrls: ['./saleitempartyst.component.scss']
})
export class SaleitempartystComponent implements OnInit {

  saleItem= new Array <ISaleItemPartyST>();
  saleItemArr= new Array<ISaleItemPartyST>();
  filterTerm:string="";
  qtyTotal:number=0;
  billTotal: number=0;
  saleArray=[];
  ...
  getReport(){
    this.service.getIPSaleWithSTReport(this.fDate, this.tDate ).subscribe(res=>{
